...
- Sobre [SARS-COV2]{"entity": "virus", "value": "SARS"} e [COVID-19]{"entity": "virus", "value": "COVID"}.
- Sobre [SARS-COV2]{"entity": "virus", "value": "SARS"} e [COVID-2019]{"entity": "virus", "value": "COVID"}.
- Sobre [SARS-COV2]{"entity": "virus", "value": "SARS"} e [COVID19]{"entity": "virus", "value": "COVID"}.
- Sobre [SARS-COV2]{"entity": "virus", "value": "SARS"} e [COVID2019]{"entity": "virus", "value": "COVID"}.
- Sobre [SARS-COV2]{"entity": "virus", "value": "SARS"} e [novo coronavirus]{"entity": "virus", "value": "COVID"}.
...
- Qual é a taxa de mortalidade
- qual o número de mortes no Brasil
...
- Mortes na [Antártica]{"entity": "world_region", "value": "Antarctic"}
...
- Quantas pessoas em estado crítico na [Antártica]{"entity": "world_region", "value": "Antarctic"}
...
- Última atualização sobre infectados em [Antartida]{"entity": "world_region", "value": "Antarctic"}
- Últimos dados de mortes no [Mundo]{"entity": "en_world_region", "value": "World"}?
...
- [Santa Sé (Estado da Cidade do Vaticano)]{"entity": "country_code", "value": "VA"} casos e mortes
...
- Últimos relatórios em [Polônia]{"entity": "country_code", "value": "KP"}.
...
- Recuperados em [Antártida]{"entity": "world_region", "value": "Antarctic"}
...
- Testes na  [Antártida]{"entity": "world_region", "value": "Antarctic"}
...
## lookup:influenza
bot/config/languages/br/data/lookup_tables/influenza.txt

## lookup:air_conditioning
bot/config/languages/br/data/lookup_tables/air_conditioning.txt

## lookup:5G
bot/config/languages/br/data/lookup_tables/5G.txt

## lookup:hand_dryer
bot/config/languages/br/data/lookup_tables/hand_dryer.txt

## lookup:uv_lamp
bot/config/languages/br/data/lookup_tables/uv_lamp.txt

## lookup:thermal_scanner
bot/config/languages/br/data/lookup_tables/thermal_scanner.txt

## lookup:antibiotics
bot/config/languages/br/data/lookup_tables/antibiotics.txt

## lookup:pneumonia_vaccine
bot/config/languages/br/data/lookup_tables/pneumonia_vaccine.txt

## lookup:saline
bot/config/languages/br/data/lookup_tables/saline.txt

## lookup:garlic
bot/config/languages/br/data/lookup_tables/garlic.txt

## lookup:sesame_oil
bot/config/languages/br/data/lookup_tables/sesame_oil.txt

## lookup:visors
bot/config/languages/br/data/lookup_tables/visors.txt
